...
def create_producer():
    ...
    try:
        producer = KafkaProducer(
            ...
            # Перетворюємо Python-об'єкти в JSON (UTF-8)
...
def generate_power_data():
    ...
    current_power = station["max_power"] * power_factor  # Потужність у МВт
...
def main():
    ...
    try:
        while True:
            ...
            try:
                future = producer.send("power-station-data-tomin", power_data)  # Відправляємо повідомлення
