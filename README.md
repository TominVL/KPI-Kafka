...
---
**РЕКОМЕНДАЦІЇ**
Для роботи “онлайн” беру погодинну схему — вона ділить дані на маленькі, керовані шматки по годинах, тож запити летять швидко й стабільно. Для звітів і архіву — добова схема з окремими підсумками на день, щоб не гребти мільйони рядків. “Просту” схему лишаю лише для демо/тестів. Часті фільтри (тип палива, викиди) — роблю окремими таблицями під конкретні запити, так найменша затримка. <br>
